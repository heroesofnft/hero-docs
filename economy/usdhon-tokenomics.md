...
Hon Token can be used as a main currency in the [Heroes of Nft marketplace](https://marketplace.heroesofnft.com/). This marketplace supports both ERC-721 and ERC-1155 tokens. Fees are below:&#x20;

* Listing fee: %1 of the listing price (free at this moment)
* Order execution fee: %4 of execution price (subject to change for balancing supply & demand, free at this moment)
